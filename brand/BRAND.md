...
| Name | Hex | Usage |
|------|-----|-------|
| Primary | `#4338CA` | Gradient start, CTA, accents |
| Secondary | `#6366F1` | Gradient end, hover states |
| Text (light bg) | `#1E1B4B` | Body text on white/light |
| Text (dark bg) | `#E8EAF2` | Body text on dark |
| Background (light) | `#FAFAFF` | Light mode |
| Background (dark) | `#0A0B14` | Dark mode |
